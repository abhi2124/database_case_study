...
Sollution :
Recognized entities in excel file
Queries in an sql file
schema diagram :https://github.com/abhi2124/database_case_study/blob/master/crs_schema_diagram.bmp
